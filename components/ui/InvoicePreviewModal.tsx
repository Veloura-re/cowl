...
export default function InvoicePreviewModal({
    ...
    return (
        <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
            ...
            <div className="glass w-full max-w-4xl h-[90vh] flex flex-col rounded-[32px] overflow-hidden shadow-2xl animate-in zoom-in-95 duration-300 relative z-10 border border-white/40 bg-white/90">
                {/* Header Actions */}
                <div className="flex items-center justify-between border-b border-black/5 px-6 py-4 bg-white/80 sticky top-0 z-20">
                    <div>
                        <h2 className="text-sm font-bold text-[var(--deep-contrast)] tracking-tight">Invoice Preview</h2>
                        <p className="text-[9px] font-bold text-[var(--foreground)]/40 uppercase tracking-wider leading-none mt-0.5">Review before finalizing</p>
                    </div>
                    <div className="flex items-center gap-2">
                        <button
                            onClick={onPrint}
                            className="p-2 rounded-xl bg-[var(--primary-green)] text-white hover:bg-[var(--primary-hover)] transition-all shadow-lg active:scale-95"
                            title="Print"
                        >
                        ...
                        <button
                            onClick={onDownload}
                            className="p-2 rounded-xl bg-[var(--deep-contrast)] text-white hover:bg-black transition-all shadow-lg active:scale-95"
                            title="Download PDF"
                        >
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-10 bg-slate-50/50 custom-scrollbar">
                    <div className="max-w-[800px] mx-auto bg-white shadow-xl rounded-lg overflow-hidden border border-black/5 flex flex-col min-h-full">
