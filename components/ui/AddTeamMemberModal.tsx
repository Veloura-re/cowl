    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-center justify-center px-4">
            ...
            <motion.div
                ...
                className="relative w-full max-w-md glass rounded-[32px] border border-[var(--foreground)]/10 shadow-2xl overflow-hidden"
            >
                <div className="px-6 py-5 border-b border-[var(--foreground)]/10 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        <div className="h-9 w-9 rounded-2xl bg-[var(--primary-green)] text-[var(--primary-foreground)] flex items-center justify-center shadow-lg shadow-[var(--primary-green)]/20">
                ...
                <div className="p-6 space-y-6">
                    <div className="flex flex-col gap-4">
                        <div className="flex gap-1.5 p-1.5 bg-[var(--foreground)]/5 border border-[var(--foreground)]/10 rounded-2xl w-fit shadow-sm">
                            <button
                        ...
                        <div className="flex gap-2">
                            <div className="relative flex-1 group">
                                {searchMode === 'email' ? (
                                    <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-[var(--foreground)]/30 group-focus-within:text-[var(--primary-green)] transition-all duration-300" />
                                ) : (
                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-[var(--foreground)]/30 font-black text-sm group-focus-within:text-[var(--primary-green)] transition-all duration-300">@</span>
                                )}
                                <input
                                    type="text"
                                    value={searchQuery}
                                    ...
                                    className="w-full h-12 rounded-[20px] bg-[var(--foreground)]/5 border border-[var(--foreground)]/10 dark:border-white/10 pl-11 pr-4 text-xs font-black text-[var(--deep-contrast)] focus:border-[var(--primary-green)] focus:ring-4 focus:ring-[var(--primary-green)]/10 focus:outline-none transition-all shadow-sm placeholder:text-[var(--foreground)]/20"
                        ...
                        {foundUser && (
                            ...
                            >
                                <div className="flex items-center gap-4 mb-6">
                                    <div className="h-14 w-14 rounded-2xl bg-[var(--background)] border border-[var(--primary-green)]/20 flex items-center justify-center text-[var(--primary-green)] font-black text-xl shadow-sm overflow-hidden">
