                ...
                <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
                    ...
                    >
                        ...
                        <div className="flex gap-3 mt-8">
                            <button
                                onClick={onClose}
                                className="flex-1 h-12 rounded-2xl bg-white border border-black/5 text-[11px] lg:text-[10px] font-black uppercase tracking-widest text-[var(--foreground)]/40 hover:bg-black/5 hover:text-[var(--deep-contrast)] transition-all active:scale-95"
                            >
                                {cancelText}
                            </button>
                            <button
                                ...
                                disabled={isLoading}
                                className={clsx(
                                    "flex-1 h-12 rounded-2xl text-white text-[11px] lg:text-[10px] font-black uppercase tracking-widest shadow-xl transition-all active:scale-95 flex items-center justify-center gap-2",
