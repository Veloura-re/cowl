                    ...
                    <div className="max-h-[300px] overflow-y-auto space-y-1 pr-1 custom-scrollbar">
                        {filteredOptions.length > 0 ? (
                            filteredOptions.map((opt) => (
                                ...
                                >
                                    <div>
                                        <p className="text-[11px] font-bold tracking-tight leading-tight">{opt.label}</p>
                                        {opt.subLabel && (
                                            <p className={clsx(
                                                "text-[8px] font-black uppercase tracking-widest leading-none mt-1.5 px-2 py-0.5 rounded-full inline-block border",
