            ...
            <form onSubmit={handleSubmit} className="space-y-3 max-w-6xl mx-auto pb-20 px-4 animate-in fade-in duration-500">
                ...
                <div className="flex items-center justify-between pb-2 border-b border-[var(--primary-green)]/10">
                    <div className="flex items-center gap-2">
                        <Link href={isSale ? "/dashboard/sales" : "/dashboard/purchases"} className="p-1 rounded-lg bg-white/50 border border-white/10 hover:bg-[var(--primary-green)] hover:text-white transition-all">
                            <ArrowLeft className="h-3 w-3" />
                        </Link>
                        <div>
                            <h1 className="text-[11px] font-bold text-[var(--deep-contrast)] uppercase tracking-tight">
                    ...
                    <div className="flex items-center gap-2">
                        {isEdit && (
                            <button
                                ...
                                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-rose-50 text-rose-500 text-[9px] font-bold uppercase tracking-wider hover:bg-rose-100 transition-all shadow-sm active:scale-95"
                            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-3">
                    ...
                    <div className="lg:col-span-1 space-y-3">
                        <div className="glass rounded-xl border border-white/40 p-3">
                            <h3 className="text-[9px] font-bold uppercase tracking-wider text-[var(--foreground)]/50 mb-2">Basic Info</h3>
                            <div className="space-y-2">
                                <div>
                                    <label className="block text-[8px] font-bold uppercase tracking-wider text-[var(--foreground)]/40 mb-1">{isSale ? 'Customer' : 'Supplier'} *</label>
                                    <button
                                        type="button"
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    <div>
                                        <label className="block text-[8px] font-bold uppercase tracking-wider text-[var(--foreground)]/40 mb-1">{isSale ? 'Invoice' : 'Bill'} #</label>
                                        <input
                                            type="text"
                                            value={invoiceNumber}
                                    ...
                                    <div>
                                        <label className="block text-[8px] font-bold uppercase tracking-wider text-[var(--foreground)]/40 mb-1">Date</label>
                                        <input
                                            type="date"
                                            value={date}
                                    ...
                                    <div>
                                        <label className="block text-[8px] font-bold uppercase tracking-wider text-[var(--foreground)]/40 mb-1">Due Date</label>
                                        <input
                                            type="date"
                                            value={dueDate}
                        ...
                        <div className="glass rounded-xl border border-white/40 p-3 space-y-3">
                            <div>
                                <label className="block text-[8px] font-bold uppercase tracking-wider text-[var(--foreground)]/40 mb-1 ml-1">Payment Mode</label>
                                <div className="flex gap-1.5">
                                    <button
                                        type="button"
                                        onClick={() => setIsModePickerOpen(true)}
                                        className={clsx(
                                            "flex-1 h-8 rounded-lg border px-3 text-[9px] font-bold flex items-center justify-center transition-all shadow-sm",
                                    ...
                                    <button
                                        ...
                                        className="h-8 px-2 rounded-lg border border-dashed border-blue-300 bg-blue-50/50 text-blue-500 hover:bg-blue-100 transition-all"
                                        title="Add Bank"
                                    >
                            ...
                            {/* Add Bank Mini Modal */}
                            {isAddBankOpen && (
                                <div className="p-2 rounded-lg bg-blue-50 border border-blue-200 animate-in slide-in-from-top-2">
                                    <label className="block text-[7px] font-bold uppercase tracking-wider text-blue-600/60 mb-1">New Bank/Mode Name</label>
                                    <div className="flex gap-1.5">
                                        <input
                                            type="text"
                                            value={newBankName}
                    ...
                    <div className="lg:col-span-3">
                        <div className="glass rounded-xl border border-white/40 overflow-hidden">
                            <div className="px-3 py-2 border-b border-white/10 bg-[var(--primary-green)]/5 flex justify-between items-center">
                                <h3 className="text-[9px] font-bold uppercase tracking-wider text-[var(--deep-contrast)]">Items ({rows.length})</h3>
                                <button
                                    type="button"
                                    onClick={() => setIsAddModalOpen(true)}
                                    className="flex items-center gap-1 px-2 py-1 rounded-lg bg-[var(--primary-green)] text-white text-[8px] font-bold uppercase hover:bg-[var(--primary-hover)] transition-all"
                                >
                            ...
                            <div className="p-3 space-y-2 max-h-[500px] overflow-y-auto">
                                {rows.length === 0 ? (
                                    <div className="text-center py-8 opacity-30">
                                        <p className="text-[8px] font-bold uppercase">No items added</p>
                                    </div>
                                ) : (
                                    rows.map((row, index) => (
                                        <div
                                            ...
                                            className="group relative glass p-2 rounded-lg border border-white/30 hover:bg-white/60 transition-all cursor-pointer active:scale-[0.98]"
                                        >
                                            <button
                                                type="button"
                                                onClick={(e) => { e.stopPropagation(); removeRow(index); }}
                                                className="absolute -top-1 -right-1 p-0.5 bg-white rounded-full border border-rose-100 text-rose-500 hover:bg-rose-500 hover:text-white transition-all z-10"
                                            >
                                            ...
                                            <div className="grid grid-cols-5 gap-2 items-center">
                                                <div className="col-span-2">
                                                    <div className="text-[9px] font-bold text-[var(--deep-contrast)]">{row.name}</div>
                                                    <div className={clsx(
                                                ...
                                                <div>
                                                    <label className="block text-[7px] font-bold uppercase text-[var(--foreground)]/30 mb-0.5">Qty × {row.unit}</label>
                                                    <input
                                                        type="number"
                                                        step="any"
                                                        value={row.quantity}
                                                        onChange={(e) => updateRow(index, 'quantity', Number(e.target.value))}
                                                        className="w-full h-7 rounded-lg bg-white/40 border border-white/10 px-2 text-[9px] font-bold text-center focus:border-[var(--primary-green)] focus:outline-none"
                                                    />
                                                </div>
                                                <div>
                                                    <label className="block text-[7px] font-bold uppercase text-[var(--foreground)]/30 mb-0.5">Rate/{row.unit}</label>
                                                    <input
                                                        type="number"
                                                        step="any"
                                                        value={row.rate}
                                                ...
                                                <div>
                                                    <label className="block text-[7px] font-bold uppercase text-[var(--foreground)]/30 mb-0.5">Total</label>
                                                    <div className="h-7 flex items-center justify-end px-2 rounded-lg bg-[var(--primary-green)]/10 text-[9px] font-bold text-[var(--primary-green)]">
                        ...
                        <div className="mt-3">
                            <textarea
                                ...
                                className="w-full h-16 rounded-xl glass border border-white/40 p-2 text-[9px] font-bold text-[var(--deep-contrast)] focus:border-[var(--primary-green)] focus:outline-none resize-none placeholder-[var(--foreground)]/20"
                            />
                        </div>
                    </div>
                </div>
