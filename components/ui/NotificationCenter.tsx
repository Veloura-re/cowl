            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className="absolute right-0 mt-2 w-80 glass rounded-[24px] border border-white/40 shadow-2xl z-[100] overflow-hidden"
                    >
                        <div className="px-5 py-4 border-b border-white/10 bg-white/40 flex items-center justify-between">
                            <div>
                                <h3 className="text-xs font-bold text-[var(--deep-contrast)]">Alert Center</h3>
                                <p className="text-[8px] font-black text-[var(--foreground)]/40 uppercase tracking-[0.2em] leading-none mt-0.5">Activities & Updates</p>
                            </div>
                            {unreadCount > 0 && (
                                <button
                                    onClick={() => markAsRead()}
