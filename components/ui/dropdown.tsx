    ...
    return (
        <div ref={dropdownRef} className={clsx("relative", className)}>
            <button
                ...
                className={clsx(
                    "flex items-center justify-between gap-2 px-3 py-2 text-[10px] font-bold rounded-xl glass border border-white/40 transition-all uppercase tracking-wider min-w-[140px]",
                    isOpen ? "border-[var(--primary-green)] bg-white/60" : "hover:border-[var(--primary-green)]/50"
                )}
            >
            ...
            {isOpen && (
                <div className="absolute top-full left-0 right-0 mt-1 z-50 animate-in fade-in slide-in-from-top-2 duration-200">
                    <div className="glass rounded-xl border border-white/40 shadow-2xl overflow-hidden backdrop-blur-xl">
                                ...
                                <button
                                    ...
                                    className={clsx(
                                        ...
                                        option.value === value
                                            ...
                                            : "text-[var(--deep-contrast)] hover:bg-white/60"
                                    )}
                                >
