        ...
        <div className="space-y-4 max-w-4xl mx-auto pb-20 px-4 sm:px-0 animate-in fade-in duration-500">
            ...
            <div className="flex items-center justify-between pb-3 border-b border-[var(--primary-green)]/10">
                <div className="flex items-center gap-2">
                    <Link href="/dashboard/sales" className="p-1.5 rounded-lg bg-white/50 dark:bg-white/10 border border-white/10 dark:border-white/5 hover:bg-[var(--primary-green)] hover:text-[var(--primary-foreground)] transition-all shadow-sm">
