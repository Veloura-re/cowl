        ...
        return (
            <div className="flex min-h-screen items-center justify-center p-6">
                <div className="glass w-full max-w-sm space-y-6 rounded-[32px] p-8 text-center border border-white/40 shadow-2xl">
                    ...
                    <p className="text-[10px] font-bold text-[var(--foreground)]/50 uppercase tracking-widest leading-relaxed">
            ...
            <div className="glass w-full max-w-sm space-y-6 rounded-[32px] p-6 relative overflow-hidden border border-white/40 shadow-2xl">
                ...
                <form className="space-y-4" onSubmit={handleUpdatePassword}>
                    <div className="space-y-3">
                        <div>
                            <label className="block text-[9px] font-bold uppercase tracking-widest text-[var(--foreground)]/60 mb-1.5 ml-1">
                                New Password
                            </label>
                            <input
                                required
