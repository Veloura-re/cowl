        ...
        <div className="relative flex min-h-screen items-center justify-center p-6 sm:p-4 overflow-hidden">
            ...
            <div className="glass w-full max-w-sm space-y-6 rounded-[32px] p-8 relative overflow-hidden border border-[var(--foreground)]/10 shadow-xl animate-in zoom-in duration-500 backdrop-blur-xl bg-white/5">
                <div className="text-center relative">
                    <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl bg-[var(--foreground)]/5 mb-6 shadow-lg border border-[var(--foreground)]/10 relative group overflow-hidden">
                    ...
                    <p className="mt-1 text-[15px] font-medium text-[var(--foreground)]/40 uppercase tracking-widest">
                ...
                <form className="space-y-5" onSubmit={handleLogin}>
                    ...
                    <div className="flex items-center justify-end px-1">
                        <Link
                            ...
                            className="text-[14px] font-medium text-[var(--primary-green)] hover:text-[var(--deep-contrast)] transition-colors uppercase tracking-[0.1em]"
                        >
                            Forgot Password?
                        </Link>
                    </div>
                ...
                <div className="text-center pt-2">
                    <p className="text-[14px] font-medium text-[var(--foreground)]/30 uppercase tracking-widest">
                        New to the network?{' '}
                        <Link
                            href="/register"
                            className="text-[var(--primary-green)] font-bold hover:text-[var(--deep-contrast)] transition-colors underline decoration-2 underline-offset-4 decoration-[var(--primary-green)]/20 ml-1"
                        >
                            Request Access
                        </Link>
                    </p>
